...
Use the normal lane for changes that alter a public page route, Astro content
schema, shared layout, or Cypress contract. Relevant product docs live under
`docs/product/`; browser evidence belongs in Cypress plus a responsive manual
check. Use Bun commands and the Moon workspace rather than introducing another
