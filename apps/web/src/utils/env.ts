...
export const PUBLIC_DEVELOPMENT_URL = import.meta.env.PUBLIC_DEVELOPMENT_URL as string;
export const PUBLIC_PRODUCTION_URL = import.meta.env.PUBLIC_PRODUCTION_URL as string;
...
export const PUBLIC_UMAMI_SRC = import.meta.env.PUBLIC_UMAMI_SRC as string;
export const PUBLIC_UMAMI_WEBSITE_ID = import.meta.env.PUBLIC_UMAMI_WEBSITE_ID as string;
export const PUBLIC_GOATCOUNTER_SRC = import.meta.env.PUBLIC_GOATCOUNTER_SRC as string;
