...
highlights:
  - "Refactored legacy Go codebase into a cleaner modular monolith clean architecture."
  ...
  - "Successfully reduced S3 storage from around 100 GB to 5 GB (95%)."
  - "Migrated the company profile from WordPress to a statically generated Astro and React site backed by Directus Headless CMS."
