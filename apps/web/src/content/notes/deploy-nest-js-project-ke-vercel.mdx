...
<Photo client:only="svelte" src="https://ik.imagekit.io/haikelz/blog/deploy-nestjs-to-vercel/Screenshot%20from%202023-07-25%2021-52-01.png?updatedAt=1690296752764" alt="default settings project" />

Apabila sudah yakin, maka klik **Deploy**.

Jika ternyata deploy berhasil, tetapi saat diakses, muncul `Error 500` seperti ini

<Photo client:only="svelte" src="https://ik.imagekit.io/haikelz/blog/deploy-nestjs-to-vercel/Screenshot%20from%202023-07-25%2021-10-27.png?updatedAt=1690296128699" alt="src import" />

maka coba cek lognya terlebih dahulu. Dalam case saya, ada kesalahan saat import file Typescriptnya.

<Photo client:only="svelte" src="https://ik.imagekit.io/haikelz/blog/deploy-nestjs-to-vercel/Screenshot%20from%202023-07-25%2021-11-42.png?updatedAt=1690296079985" alt="vercel logs" />
...
<Photo client:only="svelte" src="https://ik.imagekit.io/haikelz/blog/deploy-nestjs-to-vercel/Screenshot%20from%202023-07-25%2021-30-47.png?updatedAt=1690296079999" alt="base url tsconfig" />
...
<Photo client:only="svelte" src="https://ik.imagekit.io/haikelz/blog/deploy-nestjs-to-vercel/Screenshot%20from%202023-07-25%2021-33-40.png?updatedAt=1690296080021" alt="src import" />
...
<Photo client:only="svelte" src="https://ik.imagekit.io/haikelz/blog/deploy-nestjs-to-vercel/Screenshot%20from%202023-07-25%2021-35-24.png?updatedAt=1690296079980" alt="src import error" />
