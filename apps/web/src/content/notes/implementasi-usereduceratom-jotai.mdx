...
<Photo client:only="svelte" src="https://ik.imagekit.io/haikelz/blog/implementasi-use-reducer-atom-jotai/error-usereduceratom.png?updatedAt=1720370891940" alt="Error initialState" />

Padahal jika saya pakai `useReducer` biasa, dia ga bakal error

<Photo client:only="svelte" src="https://ik.imagekit.io/haikelz/blog/implementasi-use-reducer-atom-jotai/usereducer.png?updatedAt=1720370891898" alt="useReducer" />
