...
<Photo client:only="svelte" src="https://ik.imagekit.io/haikelz/works/asmaul-husna-api.png?updatedAt=1691043581589" alt="opengraph" />

Asma'ul Husna API is an API to get the list of Asma'ul Husna.
