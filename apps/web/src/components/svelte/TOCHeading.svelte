...
<li class="list-none!">
  <a
    href={`#${heading.slug}`}
    class="block truncate rounded-md px-2 py-1 text-sm leading-6 font-medium text-neutral-200 no-underline! transition-colors duration-150 hover:bg-neutral-800/70 hover:text-white"
  >
    {heading.text}
  </a>
